    ...
    return (
        <Box>
            ...
            <form>
                ...
                <Box sx={{ position: 'relative' }}>
                    <TextField variant='standard' type={show ? 'text' : 'password'} name='conformPassword' label='conformPassword' placeholder='Enter conform password' fullWidth required sx={{ margin: '4px 0', borderBottom: '1px solid gray' }} />
                    <Button onClick={handleShowHide} sx={{ position: 'absolute', top: '15px', right: '0' }}>
                        {show ? <BiSolidHide size={25} /> : <BiSolidShow size={25} />}
                    </Button>
                </Box>
